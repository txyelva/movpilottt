...
class FetchMediasAction(BaseAction):
    ...
    def __init__(self, action_id: str):
        ...
        self.__inner_sources = [
            ...
            {
                "func": RecommendChain().tmdb_tv_chinese,
                "name": 'TMDB热播国产剧',
                "api_path": "recommend/tmdb_tv_chinese"
            },
            {
                "func": RecommendChain().tmdb_tv_american,
                "name": 'TMDB热播美剧',
                "api_path": "recommend/tmdb_tv_american"
            },
            {
                "func": RecommendChain().tmdb_tv_korean,
                "name": 'TMDB热播韩剧',
                "api_path": "recommend/tmdb_tv_korean"
            },
            {
                "func": RecommendChain().douban_tv_domestic,
                "name": '豆瓣热门国产剧',
                "api_path": "recommend/douban_tv_domestic"
            },
            {
                "func": RecommendChain().douban_tv_american,
                "name": '豆瓣热门美剧',
                "api_path": "recommend/douban_tv_american"
            },
            {
                "func": RecommendChain().douban_tv_korean,
                "name": '豆瓣热门韩剧',
                "api_path": "recommend/douban_tv_korean"
            },
            {
