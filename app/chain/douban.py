...
class DoubanChain(ChainBase):
    ...
    def tv_domestic(self, page: Optional[int] = 1, count: Optional[int] = 30) -> Optional[List[MediaInfo]]:
        """
        获取热门国产剧
        """
        return self.run_module("tv_domestic", page=page, count=count)

    def tv_american(self, page: Optional[int] = 1, count: Optional[int] = 30) -> Optional[List[MediaInfo]]:
        """
        获取热门美剧
        """
        return self.run_module("tv_american", page=page, count=count)

    def tv_korean(self, page: Optional[int] = 1, count: Optional[int] = 30) -> Optional[List[MediaInfo]]:
        """
        获取热门韩剧
        """
        return self.run_module("tv_korean", page=page, count=count)
    ...
    async def async_tv_domestic(self, page: Optional[int] = 1,
                                count: Optional[int] = 30) -> Optional[List[MediaInfo]]:
        """
        获取热门国产剧（异步版本）
        """
        return await self.async_run_module("async_tv_domestic", page=page, count=count)

    async def async_tv_american(self, page: Optional[int] = 1,
                                count: Optional[int] = 30) -> Optional[List[MediaInfo]]:
        """
        获取热门美剧（异步版本）
        """
        return await self.async_run_module("async_tv_american", page=page, count=count)

    async def async_tv_korean(self, page: Optional[int] = 1,
                              count: Optional[int] = 30) -> Optional[List[MediaInfo]]:
        """
        获取热门韩剧（异步版本）
        """
        return await self.async_run_module("async_tv_korean", page=page, count=count)
